...
#L = ["E", "G0", "G1", "G2", "G3", "G4", "G4bis", "O", "R1", "R2", "R3", "R4", "R5", "R6", "R7", "R8", "R9",
    #"SE", "SG0", "SG1", "SG2", "SG3", "SG4", "SG4bis", "SO", "SR1", "SR2", "SR3", "SR4", "SR5", "SR6", "SR7", "SR8", "SR9"]
#
L = ["SE"]
...
for element in L:
    ...
    outfile = open("astar"+str(dirs)+"_distances_from_AA_"+name+".txt", "w")
    i = 0
